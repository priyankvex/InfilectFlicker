# Generated by Django 2.1.1 on 2018-09-22 13:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('nsid', models.CharField(db_index=True, help_text='NSID of the user', max_length=100)),
                ...
                ('user', models.ForeignKey(help_text='User related to the flicker user', on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('flicker_user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('nsid', models.CharField(db_index=True, help_text='NSID of the group', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('comment', models.TextField(help_text='Content of the note')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('nsid', models.CharField(db_index=True, help_text='NSID of the photo', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(help_text='Type of the photo URL', max_length=50)),
                ('photo', models.ForeignKey(help_text='Photo this URL belongs to', on_delete=django.db.models.deletion.CASCADE, to='photos.Photo')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('flicker_user', models.ForeignKey(help_text='Flicker user who created this tag', on_delete=django.db.models.deletion.CASCADE, to='photos.FlickerUser')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            ...
            name='group',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='photos.Group'),
        ),
        migrations.AddField(
            model_name='comment',
            name='flicker_user',
